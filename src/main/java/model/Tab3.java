 ...
 */
public class Tab3 implements java.io.Serializable {
    private Integer id;
    private String md5;
    ...
    public Tab3(int id, String md5, String content, String phone, String connectime, String recitime, float lng, float lat, int type) {
        this.id = id;
        this.md5 = md5;
